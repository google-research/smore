...
class ISampler {
public:
    ISampler(KG<Dtype>* _kg, py::list _query_prob, bool share_negative, bool _same_in_batch,
    ...
    virtual void prefetch(int _batch_size, int num_batches);
    void sample_batch_entities(bool weighted,
                               int num_samples,
                               py::array_t<long long, py::array::c_style | py::array::forcecast> _entities);
    ...
    virtual void place_batch_job(int b_idx);
