...
python ../main_train.py --do_train --do_valid --gpus '0.1.2.3' \
 ...
 -a 0.5 -adv \
 -lr 0.00005 --max_steps 500001 --geo complex --valid_steps 10000 \
 -complexm '(Mean,True,norm)' --tasks '1p.2p.3p.2i.3i.ip.pi.2u.up' --training_tasks '1p.2p.3p.2i.3i' \
 --filter_test \
 --lr_schedule none \
 --sampler_type sqrt \
 --share_negative \
 ...
 --share_optim_stats \
 --cpu_num 4 \
 --online_sample --prefix '../logs' --online_sample_mode '(5000,0,u,u,0)' --reg_coeff 0 \
