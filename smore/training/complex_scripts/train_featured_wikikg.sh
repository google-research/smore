...
python ../main_train.py --do_train --do_valid --gpus '0.1.2.3.4.5.6.7' \
 ...
 -a 1.0 -adv \
 -lr 0.1 --max_steps 10000001 --geo ComplexFeatured --valid_steps 200000 \
 --model_config '(feat-concat-768,Mean,True)' --tasks '1p' --training_tasks '1p' \
 --share_negative \
 --sampler_type naive \
 --save_checkpoint_steps 1000000 \
 --eval_link_pred \
 --dense_learning_rate 1e-4 \
 --feature_folder $data_folder/raw \
 --share_optim_stats \
 --cpu_num 4 \
