...
python ../main_train.py --do_train --do_test --gpus '0.1' \
 ...
 --port 29501 \
 --share_optim_stats \
 --online_sample --prefix '../logs' --online_sample_mode '(500,0,u,u,120)' \
