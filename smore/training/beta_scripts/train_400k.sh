...
python ../main_train.py --do_train --do_test --gpus '0.1.2.3' \
 ...
 -n 1024 -b 512 -d 800 -g 5 \
 -adv -a 0.5 \
 -lr 0.00005 --max_steps 600001 --geo beta --valid_steps 10000 \
 -betam '(1600,2,fisher,0.055,layer,True)' --tasks '1p.2p.3p.2i.3i.ip.pi' --training_tasks '1p.2p.3p.2i.3i' \
