...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python ../main_train.py --do_train --do_test --gpus '0.1.2.3.4.5.6.7' \
 --data_path $data_folder --eval_path $eval_path \
 -n 1024 -b 1024 -d 200 -g 4 \
 -a 4 -adv \
 ...
 --train_online_mode '(single,3000,e,True,before)' --optim_mode '(aggr,adam,cpu,True,5)' --online_weighted_structure_prob '(1,1,1,1,1)' --print_on_screen \
 --port 29500 \
 $@
