...
python ../main_train.py --do_train --do_valid --gpus '0.1.2.3' \
 ...
 -n 1024 -b 512 -d 800 -g 32 \
 -a 0.5 -adv \
 -lr 0.00005 --max_steps 800001 --geo rotate --valid_steps 20000 \
 -rotatem '(Mean,True)' --tasks '1p.2p.3p.2i.3i.ip.pi.2u.up' --training_tasks '1p.2p.3p.2i.3i' \
 --filter_test \
 --lr_schedule none \
 --sampler_type sqrt \
 --share_negative \
